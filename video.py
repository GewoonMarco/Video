...
async def on_member_join(member):
    await client.send_message(member, "Welkom bij **__Google Nederland__**! Heb een leuke tijd en vergeet zeker niet om een command zoals **!janee** te proberen of natuurlijk **help**! Nog een fijn verblijf in **__Google Nederland!__**")
