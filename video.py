...
async def on_member_join(member):
    await client.send_message(member, "Welkom bij **_Google Nederland_**! Heb een leuke tijd en vergeet zeker niet om een command zoals !janee te proberen of natuurlijk 'help' fijne dag!")
