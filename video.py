...
async def on_member_join(member):
    await client.send_message(member, "Welkom bij **Almere**! Heb een leuke tijd en vergeet zeker niet om een command zoals **!janee** te proberen of natuurlijk **help**! Nog een fijn verblijf in **Google Nederland!**")
...
client.run('NTYyNjc4Mzk3MTUxNjA4ODM0.XQVdEg._GLvo4xd8zhLVm_HloTJ396-IxI')
